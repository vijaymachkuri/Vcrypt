...
using SecureDock.Core.Models;
using SecureDock.Core.Services;
using SecureDock.Infrastructure.Hardware;
using System.Collections.ObjectModel;
using System.Threading.Tasks;
using System.Windows;
using System.Collections.Generic;

namespace SecureDock.UI.ViewModels
{
    public partial class MainWindowViewModel : ObservableObject
    {
        ...
        private async Task FormatAndLockAsync()
        {
            ...
            {
                MessageBox.Show("The public area must be at least 250 MB so the SecureDock application has sufficient space to reside there.", "Constraint Warning", MessageBoxButton.OK, MessageBoxImage.Warning);
                SetupPublicMB = 250;
                return;
            }
        ...
        private async Task UnlockAsync()
        {
            ...
            try
            {
                var sigPath = System.IO.Path.Combine(DetectedDriveLetter + "\\", ".securedock");
                ...
                {
                    MessageBox.Show("Signature file missing. Is this a SecureDock drive?");
                }
            }
            catch (System.Exception ex)
            {
